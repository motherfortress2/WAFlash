Date.now = function() {
  const newDate = new Date('Jan 1 2021')
  ...
  return function (Module) {
    ...
    var ASM_CONSTS = {
      ...
      2163: function ($0) {
        ...
        window.gtag &&
          window.gtag("config", "UA-168755014-1", {
            page_path: page_path,
          })
      },
      2412: function () {
    ...
    function wafjs_setstatus(msg) {
      typeof Module.setStatus == "function" &&
        Module.setStatus(UTF8ToString(msg))
    }
    ...
    var _reopenBuffer = (Module["_reopenBuffer"] = function () {
      return (_reopenBuffer = Module["_reopenBuffer"] =
        Module["asm"]["reopenBuffer"]).apply(null, arguments)
    })
    var _invokeExternalCallback = (Module["_invokeExternalCallback"] =
      function () {
        return (_invokeExternalCallback = Module["_invokeExternalCallback"] =
          Module["asm"]["invokeExternalCallback"]).apply(null, arguments)
      })
    var ___em_js__wafjs_setstatus = (Module["___em_js__wafjs_setstatus"] =
      function () {
        return (___em_js__wafjs_setstatus = Module[
          "___em_js__wafjs_setstatus"
        ] =
          Module["asm"]["__em_js__wafjs_setstatus"]).apply(null, arguments)
      })
    var ___em_js__wafjs_hidestatus = (Module["___em_js__wafjs_hidestatus"] =
      function () {
        return (___em_js__wafjs_hidestatus = Module[
          "___em_js__wafjs_hidestatus"
        ] =
          Module["asm"]["__em_js__wafjs_hidestatus"]).apply(null, arguments)
      })
    var ___em_js__wafjs_setcontentinfo = (Module[
      "___em_js__wafjs_setcontentinfo"
    ] = function () {
      return (___em_js__wafjs_setcontentinfo = Module[
        "___em_js__wafjs_setcontentinfo"
      ] =
        Module["asm"]["__em_js__wafjs_setcontentinfo"]).apply(null, arguments)
    })
    var ___em_js__getCanvasPaddingLeft = (Module[
      "___em_js__getCanvasPaddingLeft"
    ] = function () {
      return (___em_js__getCanvasPaddingLeft = Module[
        "___em_js__getCanvasPaddingLeft"
      ] =
        Module["asm"]["__em_js__getCanvasPaddingLeft"]).apply(null, arguments)
    })
    var ___em_js__getCanvasPaddingTop = (Module[
      "___em_js__getCanvasPaddingTop"
    ] = function () {
      return (___em_js__getCanvasPaddingTop = Module[
        "___em_js__getCanvasPaddingTop"
      ] =
        Module["asm"]["__em_js__getCanvasPaddingTop"]).apply(null, arguments)
    })
    ...
    var _fileno = (Module["_fileno"] = function () {
      return (_fileno = Module["_fileno"] = Module["asm"]["fileno"]).apply(
        null,
        arguments
      )
    })
    ...
    var ___em_js__wafjs_url_transformRequestUrl = (Module[
      "___em_js__wafjs_url_transformRequestUrl"
    ] = function () {
      return (___em_js__wafjs_url_transformRequestUrl = Module[
        "___em_js__wafjs_url_transformRequestUrl"
      ] =
        Module["asm"]["__em_js__wafjs_url_transformRequestUrl"]).apply(
        null,
        arguments
      )
    })
    ...
    var ___em_js__changeCursor = (Module["___em_js__changeCursor"] =
      function () {
        return (___em_js__changeCursor = Module["___em_js__changeCursor"] =
          Module["asm"]["__em_js__changeCursor"]).apply(null, arguments)
      })
